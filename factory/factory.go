...
type Unit struct {
	...
	AttackAmount float32 `json:"AttackAmount"`
...
func MakeHumanPeon(x int32, y int32, id  int32, own Owner) Unit {
	return Unit{X : x, Y: y ,Name : "P",Id: id, OwnerPlayer: own, Health: 200.0, MaxHealth: 200.0, AttackAmount: 50.0, AttackRange: 250.0, LastAttack: 0, AttackCoolDown: 150, Speed: 0.5, FlowField: nil, FlowStep: 0, FlowTarget: rl.Vector2{}}
}
